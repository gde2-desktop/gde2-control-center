...
#define CONTROL_CENTER_SCHEMA "org.gde2.control-center"
...
void handle_static_action_clicked(Tile* tile, TileEvent* event, gpointer data)
{
	...
	Gde2DesktopItem* item = (Gde2DesktopItem*) g_object_get_data(G_OBJECT(tile), APP_ACTION_KEY);
	GSettings *settings;
...
int main(int argc, char* argv[])
{
	...
	unique_app = unique_app_new("org.gde2.gde2-control-center.shell", NULL);
	...
	app_data = appshelldata_new("gde2cc.menu", GTK_ICON_SIZE_DND, FALSE, TRUE, 0);
