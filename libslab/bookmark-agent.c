...
create_app_item (BookmarkAgent *this, const gchar *uri)
{
	...
	ditem = libslab_gde2_desktop_item_new_from_unknown_id (uri);

	if (ditem) {
		uri_new = g_strdup (gde2_desktop_item_get_location (ditem));
		gde2_desktop_item_unref (ditem);
	}
