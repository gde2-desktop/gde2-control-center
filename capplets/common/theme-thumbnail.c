...
create_folder_icon (char *icon_theme_name)
{
  ...
  icon_names[i++] = "gde2-fs-directory";
  icon_names[i++] = "folder";
  icon_names[i++] = NULL;
...
generate_next_in_queue (void)
{
  ...
  if (!strcmp (item->thumbnail_type, THUMBNAIL_TYPE_META))
    generate_meta_theme_thumbnail_async ((Gde2ThemeMetaInfo *) item->theme_info,
                                         item->func,
                                         item->user_data,
                                         item->destroy);
  else if (!strcmp (item->thumbnail_type, THUMBNAIL_TYPE_GTK))
    generate_gtk_theme_thumbnail_async ((Gde2ThemeInfo *) item->theme_info,
                                        item->func,
                                        item->user_data,
                                        item->destroy);
    ...
    generate_icon_theme_thumbnail_async ((Gde2ThemeIconInfo *) item->theme_info,
                                         item->func,
                                         item->user_data,
                                         item->destroy);
...
GdkPixbuf *
generate_meta_theme_thumbnail (Gde2ThemeMetaInfo *theme_info)
{
...
GdkPixbuf *
generate_gtk_theme_thumbnail (Gde2ThemeInfo *theme_info)
{
  gchar *scheme;
...
GdkPixbuf *
generate_icon_theme_thumbnail (Gde2ThemeIconInfo *theme_info)
{
...
void
generate_meta_theme_thumbnail_async (Gde2ThemeMetaInfo *theme_info,
                                     ThemeThumbnailFunc  func,
                                     gpointer            user_data,
                                     GDestroyNotify      destroy)
{
...
void generate_gtk_theme_thumbnail_async (Gde2ThemeInfo* theme_info, ThemeThumbnailFunc  func, gpointer user_data, GDestroyNotify destroy)
{
...
void
generate_icon_theme_thumbnail_async (Gde2ThemeIconInfo *theme_info,
                                     ThemeThumbnailFunc  func,
                                     gpointer            user_data,
                                     GDestroyNotify      destroy)
{
