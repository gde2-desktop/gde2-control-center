/* gde2-network-properties.c: network preferences capplet
 *
...
/* With GSettings migration, GDE2 is going to share proxy settings with
...
#define GDE2CC_GNP_UI_FILE (GDE2CC_UI_DIR "/gde2-network-properties.ui")
			        ...
			        GtkWidget *parent)
{
	...
	if (gtk_builder_add_objects_from_file (builder, GDE2CC_GNP_UI_FILE,
	...
	capplet_set_icon (widget, "gde2-network-properties");
