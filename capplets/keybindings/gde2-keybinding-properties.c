...
create_builder (void)
{
  ...
  GError *error = NULL;
  static const gchar *uifile = GDE2CC_UI_DIR "/gde2-keybinding-properties.ui";
...
reload_key_entries (GtkBuilder *builder)
{
  ...
  dir = g_dir_open (GDE2CC_KEYBINDINGS_DIR, 0, NULL);
  if (!dir)
      return;
  ...
  for (l = list; l != NULL; l = l->next)
    ...
    path = g_build_filename (GDE2CC_KEYBINDINGS_DIR, l->data, NULL);
...
#if GTK_CHECK_VERSION(3, 0, 0)
  widget = _gtk_builder_get_widget (builder, "gde2-keybinding-dialog");
