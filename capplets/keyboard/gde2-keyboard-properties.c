...
#define KEYBOARD_SCHEMA "org.gde2.peripherals-keyboard"
#define INTERFACE_SCHEMA "org.gde2.interface"
#define TYPING_BREAK_SCHEMA "org.gde2.typing-break"
...
create_dialog (void)
{
	...
	GtkWidget *image;
	GError *error = NULL;
	static const gchar *uifile = GDE2CC_UI_DIR "/gde2-keyboard-properties-dialog.ui";
...
setup_dialog (GtkBuilder * dialog)
{
	...
	/* Ergonomics */
	monitor = g_find_program_in_path ("gde2-typing-monitor");
	if (monitor != NULL) {
		g_free (monitor);
...
main (int argc, char **argv)
{
	...
	context = g_option_context_new (_("- GDE2 Keyboard Preferences"));
