...
static Gde2kbdKeyboardDrawingGroupLevel groupsLevels[] =
    { {0, 1}, {0, 3}, {0, 0}, {0, 2} };
static Gde2kbdKeyboardDrawingGroupLevel *pGroupsLevels[] = {
...
{
	GtkWidget *kbdraw = gde2kbd_keyboard_drawing_new ();

	gde2kbd_keyboard_drawing_set_groups_levels (GDE2KBD_KEYBOARD_DRAWING
		...
		if (id != NULL) {
			...
			if (xkl_config_rec_get_from_server (data, engine)) {
				...
				if (xkl_xkb_config_native_prepare
					...
					gde2kbd_keyboard_drawing_set_keyboard
					    (GDE2KBD_KEYBOARD_DRAWING
			...
			gde2kbd_keyboard_drawing_set_keyboard
			    (GDE2KBD_KEYBOARD_DRAWING (kbdraw), NULL);
