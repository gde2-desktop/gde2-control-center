 ...
 *
 * gde2-display-properties-install-systemwide - Install a RANDR profile for the whole system
 *
...
#define SYSTEM_RANDR_PATH "/etc/gde2-settings-daemon/xrandr"
...
usage (const char *program_name)
{
	g_print (_("Usage: %s SOURCE_FILE DEST_NAME\n"
		   ...
		   "the RANDR plug-in gets run in gde2-settings-daemon.\n"
		   "\n"
