...
#define ACCESSIBILITY_SCHEMA    "org.gde2.interface"
...
{
	g_spawn_command_line_async ("gde2-default-applications-properties --show-page=a11y", NULL);
}

static void
cb_keyboard_preferences (GtkDialog *dialog, gint response_id)
{
	g_spawn_command_line_async ("gde2-keyboard-properties --a11y", NULL);
}

static void
cb_mouse_preferences (GtkDialog *dialog, gint response_id)
{
	g_spawn_command_line_async ("gde2-mouse-properties --show-page=accessibility", NULL);
}
 ...
 * based on code from gde2-session-save.c from gde2-session.
 */
